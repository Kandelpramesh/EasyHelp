  ...
  <div class="container">
    <header class="top-bar">
      ...
      <div class="auth-buttons">
        ...
        <button class="signup"><a href="customerRegistration.php">Signup as Customer</a></button>
        <button class="signup"><a href="provider.php">Signup as Provider</a></button>
      </div>
    </header>
    ...
    <main class="content">
      ...
      <div class="profile-pic">
        <img src="images/a2.jpg" alt="Profile">
      </div>
    </main>
